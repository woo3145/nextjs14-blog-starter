---
title: 'AWS Lambda + MediaConvert로 동영상 인코딩 및 썸네일 추출하기'
description: 동영상 인코딩 및 썸네일 추출 파이프라인 구축하기
date: '2023-08-31'
...
[이전글 참고 - serverless + typescript를 사용하여 AWS Lambda 배포하기](https://woo3145.com/blog/deploy-lambda-using-serverless)
...
예를들어 Apple의 Fairplay나 Google의 Widevine 같은 상용 DRM 솔루션들은 회사와 계약을 하여 라이센싱 절차를 거쳐야 라이센스 서버가 발급된다.
...
[QVBR 참고](https://docs.aws.amazon.com/ko_kr/mediaconvert/latest/ug/cbr-vbr-qvbr.html)
...
[참고](https://www.serverless.com/framework/docs/providers/aws/events/s3)
...
[참고](https://repost.aws/ko/knowledge-center/s3-console-access-certain-bucket)
