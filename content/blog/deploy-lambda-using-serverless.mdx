---
title: 'serverless + typescript를 사용하여 AWS Lambda 배포하기'
...
<a href="https://www.serverless.com/framework/docs" target="_blank">
  문서 참고
</a>
...
1. "serverless" 명령어를 입력하여 템플릿을 선택한다.

![alt text](https://d2quahb2ygxiv.cloudfront.net/bbbd7251cfa2d88532d3b.png?width=800&height=500)

2. 하지만 원하는 타입스크립트 설정이 없음으로 Other 선택

![alt text](https://d2quahb2ygxiv.cloudfront.net/bbd7251cfa2d88532d3b7.png?width=800&height=500)

3. 안내를 따라 serverless create --help 입력

![alt text](https://d2quahb2ygxiv.cloudfront.net/d7251cfa2d88532d3b727.png?width=800&height=500)

4. 다양한 템플릿이 나오는데 원하는 aws-nodejs-typescript 을 설치

```bash
serverless create --template aws-nodejs-typescript
```

![alt text](https://d2quahb2ygxiv.cloudfront.net/bd7251cfa2d88532d3b72.png?width=300&height=500)

5. 다음과 같이 템플릿이 생성되면 "npm install"로 패키지를 설치한다.
...
![alt text](https://d2quahb2ygxiv.cloudfront.net/7251cfa2d88532d3b727c.png?width=800&height=500)
...
<a
  href="https://open-sl.github.io/serverless-permission-generator"
  target="_blank"
>
  Serverless IAM 정책 생성기
</a>

![alt text](https://d2quahb2ygxiv.cloudfront.net/251cfa2d88532d3b727ce.png?width=800&height=500)

### 3. 액세스 키 만들기

![alt text](https://d2quahb2ygxiv.cloudfront.net/51cfa2d88532d3b727cea.png?width=800&height=500)

클릭

![alt text](https://d2quahb2ygxiv.cloudfront.net/1cfa2d88532d3b727ceac.png?width=800&height=500)
...
![alt text](https://d2quahb2ygxiv.cloudfront.net/cfa2d88532d3b727ceac6.png?width=800&height=500)

### 2. 클라이언트에서 사용하기 위해 인증유형 NONE 선택

![alt text](https://d2quahb2ygxiv.cloudfront.net/fa2d88532d3b727ceac65.png?width=800&height=500)

### + CORS 설정이 필요할경우 추가 설정에서 설정

![alt text](https://d2quahb2ygxiv.cloudfront.net/a2d88532d3b727ceac656.png?width=800&height=500)
...
[AWS Lambda + MediaConvert로 동영상 인코딩 및 썸네일 추출하기](https://woo3145.com/blog/encoding-with-lambda)
